...
<div class="container">		
	...
	$rating = new Rating();
	$itemDetails = $rating->getItem($_GET['pid']);
	...
	<?php	
	$itemRating = $rating->getItemRating($_GET['pid']);	
	$ratingNumber = 0;
	$count = 0;
	$fiveStarRating = 0;
	$fourStarRating = 0;
			...
			<div class="col-sm-12">
				<form id="ratingForm" method="POST">					
					<div class="form-group">
						...
						<input type="hidden" class="form-control" id="itemId" name="itemId" value="<?php echo $_GET['pid']; ?>">
